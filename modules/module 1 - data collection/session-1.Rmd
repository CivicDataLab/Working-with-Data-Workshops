...
- Source of Data Collection
  ...
  - Secondary Sources
     ...
     - Collecting data from the web
        - Web scraping 101
        - Ethical of web scraping
        - Tips and Tricks
- Data Quality Assessments
- Brief introduction about the second session [Data scraping vs Data standards]

---

# Starting a Data Project / Data literacy slide
...
[2] [ Karl W. Broman & Kara H. Woo (2018) Data Organization in Spreadsheets, The American Statistician, 72:1, 2-10, DOI: 10.1080/00031305.2017.1375989 ](https://doi.org/10.1080/00031305.2017.1375989)
]
...
# Common warnings and errors in CSV files
.panelset[.panel[.panel-name[Errors]
...
# More resources on working with CSV files
...
[Tabula](https://tabula.technology/) only works on text-based PDFs, not scanned documents. If you can click-and-drag to select text in your table in a PDF viewer (even if the output is disorganized trash), then your PDF is text-based and Tabula should work.
...
.footnote[
[1] [An introduction to Statistical Programming Methoda in R](https://smac-group.github.io/ds/web-scraping-in-r.html)
]
