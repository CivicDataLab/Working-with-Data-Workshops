...
| 7 | Data Analysis - Use Cases | 09/09/21 | [`r fa(name = "firefox-browser", fill = "steelblue", height = "20px")`](https://civicdatalab.in/Working-with-Data-Workshops/modules/module_3_data_analysis/session-1.html) [`r fa(name = "file-pdf", fill = "steelblue", height = "20px")`](https://civicdatalab.in/Working-with-Data-Workshops/modules/module_3_data_analysis/session-1.pdf) | [`r fa(name = "youtube", fill = "steelblue", height = "20px")`]() | [`r fa(name = "file-word", fill = "steelblue", height = "20px")`]() |
