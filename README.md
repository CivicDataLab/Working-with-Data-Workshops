...
Note: Certain keyboard shortcuts are available for the HTML version of
the slide decks. All of them van be viewed by pressing the key `h` after
you have opened the file in your browser.
